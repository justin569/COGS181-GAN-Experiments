...
'''
Code from Niko Gamulin who implemented ResNet by scratch:
https://niko-gamulin.medium.com/resnet-implementation-with-pytorch-from-scratch-23cf3047cb93

I modified the code to fit my needs
'''
...
# resnet = ResNet(num_layers=50, block=Block, image_channels=3, num_classes=1000)